...
cols0,train,extra_y,test=cols_train_y_test(2,loadtest=True)
...
os.execv(sys.executable,[sys.executable]+[e.replace('genlgb','genxgb') for e in sys.argv])
